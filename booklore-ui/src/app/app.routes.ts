...
export const routes: Routes = [
  ...
  {path: 'oauth2-callback', component: OidcCallbackComponent},
  {
    ...
    children: [
      ...
      {path: 'all-books', loadComponent: () => import('./features/book/components/book-browser/book-browser.component').then(m => m.BookBrowserComponent), canActivate: [AuthGuard]},
      {path: 'settings', loadComponent: () => import('./features/settings/settings.component').then(m => m.SettingsComponent), canActivate: [AuthGuard]},
      {path: 'library/:libraryId/books', loadComponent: () => import('./features/book/components/book-browser/book-browser.component').then(m => m.BookBrowserComponent), canActivate: [AuthGuard]},
      {path: 'shelf/:shelfId/books', loadComponent: () => import('./features/book/components/book-browser/book-browser.component').then(m => m.BookBrowserComponent), canActivate: [AuthGuard]},
      {path: 'unshelved-books', loadComponent: () => import('./features/book/components/book-browser/book-browser.component').then(m => m.BookBrowserComponent), canActivate: [AuthGuard]},
      ...
      {path: 'comic-review', loadComponent: () => import('./features/comics/comic-review.component').then(m => m.ComicReviewComponent), canActivate: [AuthGuard]},
